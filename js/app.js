...
(function($) {
	...
	// User pool
	var poolData = {
			UserPoolId : 'us-east-1_ff4tocxNs', // Your user pool id here
			ClientId : '4g923c68t0vvv7uqjd1ogrf6du' // Your app client id here
	};

	// Your identity pool id here
	var identityPoolId = "us-east-1:784f752e-173a-4ea1-b4ff-1c003b5d410b"
	...
	function createCredentials(idToken) {
		AWS.config.credentials = new AWS.CognitoIdentityCredentials({
			...
			Logins : {
				...
				'cognito-idp.us-east-1.amazonaws.com/us-east-1_ff4tocxNs' : idToken
			}
		});
  ...
  cognitosync.updateRecords(params, function(err, data) {
	...
	function createObject(){
		if (cognitoUser != null) {
			...
			var bucketName = 'backspace-lab-isaac'; /* change to your bucket name!! */
	    var objParams = {
	        Bucket: bucketName,
	        Key: key,
	        ContentType: 'json',
